...
export function PresetNav({ currentPresetName, onPrev, onNext }: PresetNavProps) {
  return (
    <div className="flex items-center gap-3 mb-3 z-[2]">
      <button
        className="w-[30px] h-[30px] rounded-full border-none text-white/40 text-sm cursor-pointer flex items-center justify-center transition-all duration-150 hover:text-body active:scale-95"
        style={{
      ...
      <span className="text-[11px] tracking-[0.12em] uppercase text-white/50 min-w-[120px] text-center">
        {currentPresetName}
      </span>
